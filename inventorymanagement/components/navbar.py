...
from inventorymanagement import styles
import reflex as rx
...
def navbar_footer() -> rx.Component:
    ...
    return rx.hstack(
        rx.link(
            rx.text("Made by Teertha for you", size="1"),
            href="https://teertha.reflex.run/",
            color_scheme="gray",
            underline="none",
        ),
        rx.spacer(),
...
def navbar() -> rx.Component:
    ...
    return rx.el.nav(
        rx.hstack(
            rx.text("Inventory Management", size="5", weight="bold"),
            rx.spacer(),
            menu_button(),
            align="center",
            width="100%",
